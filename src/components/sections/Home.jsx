...
export const Home = () => {
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-8xl min-h-26 font-bold m-10 title-gradient">
                Hi, I'm Daniel.
            </h1>

            <p className="text-gray-200 text-lg mb-8 max-w-180 mx-auto justify-center">
    ...
    <div className="group rounded-4xl text-center transition-all duration-300">
