...
export const Projects = () => {
    return (
        ...
        <section id="projects" className="min-h-screen flex items-center justify-center">
            ...
            <h2 className="title-gradient  sm:mt-0" id="title">Featured Projects</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="p-6 rounded-xl border border-white/20 hover:-translate-y-2 hover:border-indigo-500/60 hover:border-3 transition">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                            ...
                            <div className="flex justify-center p-3.5 bg-gray-50 rounded-2xl shadow-lg shadow-purple-100/30 hover:bg-gray-100 hover:scale-105 transition-all">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="mr-2 fill-current" viewBox="0 0 1792 1792">
                    ...
                    <div className="p-6 rounded-xl border border-white/20 hover:-translate-y-2 hover:border-indigo-500/60 hover:border-3 transition">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                            <div className="flex justify-center p-4 bg-neutral-700 rounded-2xl shadow-lg shadow-purple-200/20 hover:bg-neutral-800 hover:scale-105 transition-all">
